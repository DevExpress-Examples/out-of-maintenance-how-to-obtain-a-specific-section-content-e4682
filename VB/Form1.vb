...
Namespace RichEditSectionContent
	Partial Public Class Form1
		...
		Private Sub button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles button1.Click
			...
			Dim currentParagraph As Paragraph = document.GetParagraph(document.CaretPosition)

			For i As Integer = 0 To document.Sections.Count - 1
				If document.Sections(i) Is currentSection Then
			...
			For i As Integer = 0 To currentSection.Paragraphs.Count - 1
				If currentSection.Paragraphs(i) Is currentParagraph Then
			...
			MessageBox.Show("Current Setion Text (PlainText Format):" & Constants.vbCrLf & currentSetionText)
		End Sub
	End Class
End Namespace